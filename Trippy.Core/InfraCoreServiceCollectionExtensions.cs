...
namespace Trippy.InfraCore
{
    public static class InfraCoreServiceCollectionExtensions
    {
             public static IServiceCollection AddInfraCoreServiceCollectionExtensions(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<ITripNotesRepository, TripNoteRepository>();
            ...
            services.AddScoped<IVehicleMaintanenceRepository, VehicleMainteanceRepository>();
            services.AddScoped<ITripKiloMeterRepository, TripKiloMeterRepository>();
            ...
            services.AddScoped<IAppMasterSettingRepository, AppMasterSettingRepository>();
